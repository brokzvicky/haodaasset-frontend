...
const ADMIN_NAV = [
  ...
  { to: "/attendance",     label: "Attendance",     icon: "attendance", section: "MAIN", permission: "ATTENDANCE_VIEW" },
...
const EMP_NAV = [
  ...
  { to: "/emp/attendance", label: "My Attendance",  icon: "attendance", section: "MAIN"   },
